package es.iesnervion.android.listadinamicainflater;
...
public class ListaDinamicaInflater extends ListActivity {
  TextView selection;
  ...
  public void onCreate(Bundle icicle) {
    ...
    setContentView(R.layout.activity_lista_dinamica_inflater);
